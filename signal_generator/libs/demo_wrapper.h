...
void demo_wf_set_x(int p_waveform_mode, double p_freq, double p_amp, double p_offset, double p_phase); // zero freq(strange waveform) and amp(wrong freq) generate bug
